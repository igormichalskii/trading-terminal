...
import type { FlatTopBottomDrawing } from "../drawings";
import type React from "react";
import { lineDashForStyle } from "../drawingUtils";

class FlatTopBottomRenderer implements IPrimitivePaneRenderer {
    private _drawing: FlatTopBottomDrawing;
    private _seriesRef: React.RefObject<any>;
    private _chartRef: React.RefObject<any>;
    private _isSelected: boolean;

    constructor(drawing: FlatTopBottomDrawing, seriesRef: React.RefObject<any>, chartRef: React.RefObject<any>, isSelcted: boolean) {
...
class FlatTopBottomPaneView implements IPanePrimitivePaneView {
    private _drawing: FlatTopBottomDrawing;
    private _seriesRef: React.RefObject<any>;
    private _chartRef: React.RefObject<any>;
    private _isSelected: boolean;
    ...
    renderer(): IPrimitivePaneRenderer {
        return new FlatTopBottomRenderer(this._drawing, this._seriesRef, this._chartRef, this._isSelected);
    }
}

export class FlatTopBottomPrimitive implements IPanePrimitive {
    private _drawing: FlatTopBottomDrawing;
    private _seriesRef: React.RefObject<any>;
    private _chartRef: React.RefObject<any>;
    private _isSelected: boolean;
    ...
    paneViews() {
        return [new FlatTopBottomPaneView(this._drawing, this._seriesRef, this._chartRef, this._isSelected)]
    }

    update(drawing: FlatTopBottomDrawing, isSelected: boolean) {
        this._drawing = drawing;
